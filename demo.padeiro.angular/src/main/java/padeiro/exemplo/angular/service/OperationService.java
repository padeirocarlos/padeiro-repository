...
public class OperationService {
	...
	public Page<ProjectionOperation> findProjectionOperationByDescriptionAndDate(final LocalDate validatyDate,
		...
		return getOperationRepositoryQuery().findProjectionOperationByDescriptionAndDate(validatyDate, description,pageable);

	}
	
	public Page<ProjectionOperation> findProjectionOperationByDescriptionAndOperationType(final String operationType,
			final String description,Pageable pageable) {

		return getOperationRepositoryQuery()
				.findProjectionOperationByDescriptionAndOperationType(OperationEnum.valueOf(operationType), description,pageable);
